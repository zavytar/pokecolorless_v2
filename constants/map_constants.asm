...
; - scripts and events (see data/maps/scripts.asm)
	...
	map_const POKEMON_TOWER_1F,								10, 9 ;	 7
	map_const POKEMON_TOWER_2F,								10, 9 ;	 7
	map_const POKEMON_TOWER_3F,								10, 9 ;	 7
	map_const POKEMON_TOWER_4F,								10, 9 ;	 7
	map_const POKEMON_TOWER_5F,								10, 9 ;	 7
	endgroup
	...
	map_const ROUTE_3,										10, 9 ;	 5
	map_const MOUNT_MOON_OUTSIDE,							10, 9 ;	 6
	map_const MOUNT_MOON_POKECENTER,						10, 9 ;	 7
	endgroup
	...
	map_const UNDERGROUND_PATH_NORTH_SOUTH,					 4,	20 ;  2
	map_const ROUTE_6_UNDERGROUND_ENTRANCE,                	 4,  4 ; 14
	map_const VERMILLION_CITY,             		             5,  6 ;  2
	map_const VERMILLION_POKECENTER,                       	 4,  4 ;  3
	map_const VERMILLION_MART,       	                     4,  4 ;  4
	map_const VERMILLION_GYM,	                             4,  4 ;  5
	map_const VERMILLION_FISHING_GURUS_HOUSE,                4,  4 ;  6
	map_const VERMILLION_FAN_CLUB,                           4,  4 ;  7
	map_const VERMILLION_HOUSE_1,                            4,  4 ;  8
	map_const VERMILLION_HOUSE_2,                            4,  4 ;  9
	map_const ROUTE_11,										10,  9 ; 10
	map_const ROUTE_11_GATE_1F,								10,  9 ; 11
	map_const ROUTE_11_GATE_2F,								10,  9 ; 12
	endgroup
	...
	map_const ROUTE_8_UNDERGROUND_ENTRANCE,                	 4,  4 ; 14
	map_const UNDERGROUND_PATH_WEST_EAST,					20,	 4 ;  2
	...
	map_const ROUTE_7_UNDERGROUND_ENTRANCE,                	 4,  4 ; 14
	map_const CELADON_CITY,           		                 5,  6 ;  2
	map_const CELADON_POKECENTER,                          	 4,  4 ;  3
	map_const CELADON_DEPT_STORE_1F,                       	 4,  4 ;  4
	map_const CELADON_DEPT_STORE_2F,                       	 4,  4 ;  4
	map_const CELADON_DEPT_STORE_3F,                       	 4,  4 ;  4
	map_const CELADON_DEPT_STORE_4F,                       	 4,  4 ;  4
	map_const CELADON_DEPT_STORE_5F,                       	 4,  4 ;  4
	map_const CELADON_GYM,	                             	 4,  4 ;  5
	map_const CELADON_GAME_CORNER,                         	 4,  4 ;  6
	map_const CELADON_PRIZE_CORNER,                        	 4,  4 ;  6
	map_const CELADON_MANSION_1F,                       	 4,  4 ;  4
	map_const CELADON_MANSION_2F,                       	 4,  4 ;  4
	map_const CELADON_MANSION_3F,                       	 4,  4 ;  4
	map_const CELADON_MANSION_4F,                       	 4,  4 ;  4
	map_const CELADON_MANSION_ROOM,							 4,  4 ;  4
	map_const CELADON_RESTAURANT,                          	 4,  4 ;  7
	map_const CELADON_HOTEL,                            	 4,  4 ;  8
	map_const CELADON_HOUSE_1,                            	 4,  4 ;  9
	map_const ROUTE_16,										10,  9 ; 10
	map_const ROUTE_16_GATE_1F,								10,  9 ; 11
	map_const ROUTE_16_GATE_2F,	                           	 4,  4 ; 12
	map_const ROUTE_16_HOUSE_1,								10,  9 ; 13
	endgroup	
	...
	map_const SAFFRON_POKECENTER,                       	 4,  4 ;  3
	map_const SAFFRON_MART,       	                    	 4,  4 ;  4
	map_const SAFFRON_GYM,	                            	 4,  4 ;  5
	map_const FIGHTING_DOJO,                            	 4,  4 ;  5
	map_const MR_PSYCHICS_HOUSE,                           	 4,  4 ;  5
	map_const COPYCATS_HOUSE,                            	 4,  4 ;  5
	map_const SAFFRON_HOUSE_1,	                           	 4,  4 ;  5
	endgroup
