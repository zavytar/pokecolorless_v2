...
MapGroup_Pallet:
	...
	map OaksLab, TILESET_LAB, INDOOR, LANDMARK_PALLET_TOWN, MUSIC_BATTLE_TOWER_LOBBY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RedsHouse1F, TILESET_HOUSE, INDOOR, LANDMARK_PALLET_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RedsHouse2F, TILESET_HOUSE, INDOOR, LANDMARK_PALLET_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BluesHouse1F, TILESET_HOUSE, INDOOR, LANDMARK_PALLET_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PalletTown, TILESET_KANTO, TOWN, LANDMARK_PALLET_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
